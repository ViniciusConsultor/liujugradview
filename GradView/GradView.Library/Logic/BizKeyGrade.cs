...
{	
	...
	/// </summary>
	[DataObject(true)]
	public partial class BizKeyGrade
	{
		private static IDataBaseOperate< KeyGrade> baseOperate =(IDataBaseOperate< KeyGrade>) DaoFactory.CreateInstance("DaoKeyGrade");
		
		#region BaseOperation
		
		/// <summary>
		/// 在dbo.key_grade中增加一条记录
		/// </summary>
		...
		/// <returns>影响行数</returns>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public static int Insert(KeyGrade model,object trans)
		{
			if(model != null && trans !=null)
				return baseOperate.Insert(model,trans);
			else
			 	throw new ApplicationException("在dbo.key_grade中增加一条记录时,传递的参数model,trans有错误！");;
		}
		...
		/// <summary>
		/// 在dbo.key_grade中完整更新一条记录
		/// </summary>
		/// <param name="model">包含被更新数据的实体对象</param>
		/// <returns>影响行数</returns>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public static int  Update(KeyGrade model)
		{
			if(model != null)
				return baseOperate.Update(model);
			else
				 throw new ApplicationException("在dbo.key_grade中更新一条记录时,传递的参数model为Null！");
		}
		
		/// <summary>
		/// 在dbo.key_grade中完整更新一条记录,支持数据库事务
		/// </summary>
		/// <param name="model">包含被更新数据的实体对象</param>
		/// <param name="trans">事务参数</param>
		/// <returns>影响行数</returns>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public static int Update(KeyGrade model,object trans)
		{
			if(model != null && trans !=null)
				return baseOperate.Update(model,trans);
			else
			   throw new ApplicationException("在dbo.key_grade中更新一条记录时,传递的参数model,trans有错误！");
		}
      	...
      	public static int Update(string sql, object[] parms)
		{
			if(sql != null && parms !=null)
			   ...
			   throw new ApplicationException("根据指定的Sql在dbo.key_grade中更新一条记录时,传递的参数sql,parms有错误！");
		}
      	...
      	public static int Update(string sql, object[] parms, object trans)
		{
			if(sql != null && parms !=null && trans !=null)
			   ...
			   throw new ApplicationException("根据指定的Sql在dbo.key_grade中更新一条记录时,传递的参数sql,parms,trans有错误！");
		}
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
      	public static KeyGrade  GetModel(string sql,object[] parms)
		{
			if(!string.IsNullOrEmpty(sql))
				return baseOperate.GetModel(sql,parms);	
			else
				throw new ApplicationException("根据指定的SQL获取dbo.key_grade中的一条记录时,传递的参数sql为Null！");
		}
		...
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public static IList<KeyGrade> GetList()
		{
		...
		/// <returns>记录集</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public static IList<KeyGrade> GetList(string sql,object[] parms)
		{
			if(!string.IsNullOrEmpty(sql))
				return baseOperate.GetList(sql,parms);	
			else
				throw new ApplicationException("根据指定的SQL在dbo.key_grade中获取所有记录时,传递的参数sql为Null！");
		}	
