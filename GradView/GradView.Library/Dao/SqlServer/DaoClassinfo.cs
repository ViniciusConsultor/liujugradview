...
namespace gv.Data.SqlServer
{
	...
	partial class DaoClassinfo:IDataBaseOperate<Classinfo>
	{
		...
		{
			string sql = "INSERT INTO classInfo (bjid,bjmc,bjpy,phx) VALUES (@bjid,@bjmc,@bjpy,@phx)";
		...
		{
		    string sql= "UPDATE classInfo SET bjmc=@bjmc, bjpy=@bjpy, phx=@phx WHERE 1=1  AND bjid=@bjid";
