...
{	
	...
	///Description: SysTableconfig业务逻辑操作类
	///@author LiuJu
	///@version 1.0.0.0
	///@date 2009-8-26
	///@modify 
	...
	/// </summary>
	[DataObject(true)]
	public partial class BizSysTableconfig
	{
		private static IDataBaseOperate< SysTableconfig> baseOperate =(IDataBaseOperate< SysTableconfig>) DaoFactory.CreateInstance("DaoSysTableconfig");
		
		#region BaseOperation
		
		/// <summary>
		/// 在dbo.sys_TableConfig中增加一条记录
		/// </summary>
		...
		/// <returns>影响行数</returns>
		[DataObjectMethod(DataObjectMethodType.Insert)]
		public static int Insert(SysTableconfig model,object trans)
		{
			if(model != null && trans !=null)
				return baseOperate.Insert(model,trans);
			else
			 	throw new ApplicationException("在dbo.sys_TableConfig中增加一条记录时,传递的参数model,trans有错误！");;
		}
		...
		/// <summary>
		/// 在dbo.sys_TableConfig中完整更新一条记录
		/// </summary>
		/// <param name="model">包含被更新数据的实体对象</param>
		/// <returns>影响行数</returns>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public static int  Update(SysTableconfig model)
		{
			if(model != null)
				return baseOperate.Update(model);
			else
				 throw new ApplicationException("在dbo.sys_TableConfig中更新一条记录时,传递的参数model为Null！");
		}
		
		/// <summary>
		/// 在dbo.sys_TableConfig中完整更新一条记录,支持数据库事务
		/// </summary>
		/// <param name="model">包含被更新数据的实体对象</param>
		/// <param name="trans">事务参数</param>
		/// <returns>影响行数</returns>
		[DataObjectMethod(DataObjectMethodType.Update)]
		public static int Update(SysTableconfig model,object trans)
		{
			if(model != null && trans !=null)
				return baseOperate.Update(model,trans);
			else
			   throw new ApplicationException("在dbo.sys_TableConfig中更新一条记录时,传递的参数model,trans有错误！");
		}
      	...
      	public static int Update(string sql, object[] parms)
		{
			if(sql != null && parms !=null)
			   ...
			   throw new ApplicationException("根据指定的Sql在dbo.sys_TableConfig中更新一条记录时,传递的参数sql,parms有错误！");
		}
      	...
      	public static int Update(string sql, object[] parms, object trans)
		{
			if(sql != null && parms !=null && trans !=null)
			   ...
			   throw new ApplicationException("根据指定的Sql在dbo.sys_TableConfig中更新一条记录时,传递的参数sql,parms,trans有错误！");
		}
		...
		[DataObjectMethod(DataObjectMethodType.Select)]
      	public static SysTableconfig  GetModel(string sql,object[] parms)
		{
			if(!string.IsNullOrEmpty(sql))
				return baseOperate.GetModel(sql,parms);	
			else
				throw new ApplicationException("根据指定的SQL获取dbo.sys_TableConfig中的一条记录时,传递的参数sql为Null！");
		}
		...
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public static IList<SysTableconfig> GetList()
		{
		...
		/// <returns>记录集</returns>
		[DataObjectMethod(DataObjectMethodType.Select)]
		public static IList<SysTableconfig> GetList(string sql,object[] parms)
		{
			if(!string.IsNullOrEmpty(sql))
				return baseOperate.GetList(sql,parms);	
			else
				throw new ApplicationException("根据指定的SQL在dbo.sys_TableConfig中获取所有记录时,传递的参数sql为Null！");
		}	
