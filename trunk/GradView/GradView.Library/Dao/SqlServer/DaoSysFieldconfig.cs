...
namespace GradView.Library.Data.SqlServer
{
	...
	partial class DaoSysFieldconfig:IDataBaseOperate<SysFieldconfig>
	{
		...
		{
			string sql = "INSERT INTO sys_FieldConfig (xsid,tableid,fieldName,fieldNameCh,ShowMaxLength,ShowSort,isPK,isShow,isSelect,isIntType,isFK,FKTableName,FKTablePK,FKTableField,regexTypeID,editTypeID,regrxText,keyTableID,isEdit,EditSort,EditMinLength,EditMaxLength,isMust) VALUES (@xsid,@tableid,@fieldName,@fieldNameCh,@ShowMaxLength,@ShowSort,@isPK,@isShow,@isSelect,@isIntType,@isFK,@FKTableName,@FKTablePK,@FKTableField,@regexTypeID,@editTypeID,@regrxText,@keyTableID,@isEdit,@EditSort,@EditMinLength,@EditMaxLength,@isMust)";
