...
function _Fun_BindPageTable()
{
    ...
    while(_GV_TableInfoJson[Ti]!=null)
    {
        ...
        if(B_isEdit)
        {
            B_htmlStr+="<td><a href=\"#nogo\" onclick=\"_Fun_T_Table_edit_click('"+B_tableName+"','"+B_tableSPK+"','"+_GV_TableInfoJson[Ti][B_tableSPK]+"')\">编辑</a></td>";
        }
        
        //是否可以删除
        if(B_isDel)
        {
            B_htmlStr+="<td><a href=\"#nogo\" onclick=\"_Fun_T_Table_del_click('"+B_tableName+"','"+B_tableSPK+"','"+_GV_TableInfoJson[Ti][B_tableSPK]+"')\">删除</a></td>";
        }
        
        //是否可以自定列
        if(B_isAutoColumn)
        {
            B_htmlStr+="<td><a href=\"#nogo\" onclick=\"_Fun_T_Table_autoCoulmn_click('"+B_tableName+"','"+B_tableSPK+"','"+_GV_TableInfoJson[Ti][B_tableSPK]+"')\">"+B_AutoColumnName+"</a></td>";
        }
